document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('../IT_Department/it_news.json')
...
async function fetchFacultyData() {
    try {
        const response = await fetch('../IT_Department/it_faculty.json'); // Assuming JSON file name is faculty.json
        ...
        facultyData.forEach(faculty => {
            ...
            facultyImage.src = `../IT_Department/faculty/${faculty.image}`;
